...
import sty from "./PlasmicNavItem.module.css"; // plasmic-import: 182MzcAth_z9/css
    ...
    () => [
      {
        ...
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => $props.hasIconOnly
      }
    ],
    [$props, $ctx, $refs]
  );
      ...
      >
        ...
        {(hasVariant($state, "hasIconOnly", "hasIconOnly") ? true : false)
          ? renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(projectcss.all, sty.svg___7Yl8S)}
                  role={"img"}
                />
              ),
